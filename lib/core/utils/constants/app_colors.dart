...
class AppColors {
  ...
  static const serfeceBG = Color(0xffFFFFFF);
  static const primaryText = Color(0xff333333);
  static const primaryColor = Color(0xff096E76);
  static const textWhite = Color(0xffFFFFFF);
  static const primaryColor2 = Color(0xffFFA500);
  static const primaryColor3 = Color(0xffDE1B29);
  ...
  static const primaryButton = Color(0xff0A6F77);
  ...
  static const lightRead = Color(0xffFFAFAF);
